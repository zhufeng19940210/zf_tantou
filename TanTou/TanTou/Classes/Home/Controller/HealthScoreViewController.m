...
@interface HealthScoreViewController ()
//显示图片ImageView
...
@end
@implementation HealthScoreViewController
-(void)dealloc {
...
- (void)setupUI {
    ...
    self.photoImageView.origin = CGPointMake(0, 64 + ZXSRealValueFit6SWidthPt(40));
    self.buttomContainView.origin = CGPointMake(0, 64 + ZXSRealValueFit6SWidthPt(80) + self.screenwidth);
    self.animationImageView.center = CGPointMake(self.screenwidth * 0.5, self.screenwidth * 0.5 + 64 + ZXSRealValueFit6SWidthPt(40));
    // 配置帧动画
